...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-md-7 d-flex flex-row justify-content-center">
                        <a href="gallery.php"><button class="doc_button" class="btn btn-primary">Images</button></a>
                    </div>
                    <div class="col-12 col-md-3 d-flex flex-row justify-content-center mt-2">
                        <a href="galleryvideos.php"><button class="doc_button" class="btn btn-primary">Videos</button></a>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="row mt-3">
                    <div class="col-12 col-md-6">
                        <!-- <img src="assets/images/tripura phamplet 1.jpg" class="img-fluid" /> -->
                    </div>
                    <div class="col-12 col-md-6">
                        <!-- <img src="assets/images/tripura phamplet 01.jpg" class="img-fluid" /> -->
                    </div>
                    <!-- <div class="col-12 col-md-4">
                <img src="assets/images/blog2 small.png" class="img-fluid"/>
                </div> -->
