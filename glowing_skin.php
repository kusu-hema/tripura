...
<body>
    ...
    <div class="section1 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="blogs-head" style="font-size: 42px;">Glowing Skin</h1>
                    ...
                    <p class="blogs_para alignments mt-2">Achieve radiant and luminous skin with our customized treatments designed to rejuvenate and revitalize your complexion, leaving you with a healthy and glowing appearance.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/led light large.png" class=" doc_img_one img-fluid" alt="...">

                </div>
                <div class="col-md-6  order-2 order-md-2 mt-2">
                    <h6 class="shedual_heading">Make a Schedule</h6>
                    <h2 class="shedual_para">Led Light Therapy</h2>
    ...
    <!-- Medifacials -->
    <section id="Medifacials">
        <div class="container mt-5  div_first_con">
            <div class="row">
                
                <div class="col-md-6 order-2 order-md-1">
                    <h6 class="shedual_heading">Make a Schedule</h6>
                    <h2 class="shedual_para">Medifacials</h2>
                    <p class="sahde_color">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-2">
                    <img src="assets/images/medi facials large.png" class=" doc_img_one img-fluid" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Laser Toning -->
    <section id="Laser_Toning">
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/laser toning large.png" class=" doc_img_one img-fluid" alt="...">
    ...
    <section id="Skin_Booster">
        <div class="container mt-5  div_first_con">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-2">
                    <img src="assets/images/skin booster large.png" class=" doc_img_one img-fluid" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="Growth_factor_Concentrate">
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/growthfactor large.jpg" class=" doc_img_one img-fluid" alt="...">
                </div>
                <div class="col-md-6  order-2 order-md-2 mt-2">
                    <h6 class="shedual_heading">Make a Schedule</h6>
    ...
    <section id="Hydra_Facial">
        <div class="container mt-5  div_first_con">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-2">
                    <img src="assets/images/hydrafacial large.png" class=" doc_img_one img-fluid" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Vampire Facial -->
    <section id="Vampire_Facial">
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/vampirefacial large.png" class=" doc_img_one img-fluid" alt="...">
                </div>
                <div class="col-md-6  order-2 order-md-2 mt-2">
                    <h6 class="shedual_heading">Make a Schedule</h6>
                    <h2 class="shedual_para">Vampire Facial</h2>
